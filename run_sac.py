...
from CarRacingEnv.wrappers import PreprocessWrapper, FrameSkipWrapper, FrameStack, ThrottleActionWrapper, RewardShapingWrapper
        ...
        if total_steps % checkpoint_interval == 0 and total_steps > 0:
            ...
            for evaluation_episode in range(5):
                ...
                while not evaluation_done and evaluation_steps < max_ep_len:
                    ...
                    evaluation_obs, step_reward, evaluation_terminated, evaluation_truncated, _ = eval_env.step(evaluation_action)
                ...
                print(f"    Eval Episode {evaluation_episode + 1}: {evaluation_ep_reward:.2f}")
